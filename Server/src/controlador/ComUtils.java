...
public class ComUtils {
    ...
    private DataInputStream input;      // Lectura del buffer del DataSocket.
    private DataOutputStream output;    // Escritura en el buffer del DataSocket.
     ...
     * @param socket DataSocket ya creado previamente.
     */
